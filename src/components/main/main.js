 ...
 * @function
 * @name Main
 * @description Функция-компонент, которая рендерит основную страницу с категориями товаров и новыми поступлениями.
 * @param {Object} props - Объект с реквизитами, передаваемыми в компонент.
 * @returns {JSX.Element} Возвращает JSX элемент, представляющий основную страницу с товарами.
 */
